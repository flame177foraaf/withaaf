...
router.get('/:id', (req, res, next) => {
  ...
  client.query("SELECT developid, developproject, developcontent FROM aquafeq.developboard WHERE developid=$1", [id], (err, response) => {
...
router.post('/', (req, res, next) => {
  client.query("INSERT INTO aquafeq.developboard(developid, developproject, developcontent) values ($1, $2, $3, to_char(now(),'YYYY-MM-DD'))", [req.body.title, req.body.boardbody, req.body.writer], (err, response) => {
