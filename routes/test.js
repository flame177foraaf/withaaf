              ...
              await client.query(QueryString, ['%' + Search + '%'], async function(err, dataARM) {
                  ...
                  await client.query(QueryString, ['%' + Search + '%'], async function(err, dataACC) {
                    ...
                    var test = 'Tower';
                      ...
                      await client.query(QueryString, ['%' + Search + '%' , '%' + test+ '%'], async function(err, dataMonsterField) {
                        ...
                        var test = 'Tower';
                          ...
                          await client.query(QueryString, ['%' + Search + '%', '%' + test+ '%'], function(err, dataMonsterTower) {
                            console.log(QueryString)
