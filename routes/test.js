...
router.get('/addwp', async (req,res,next) => {
  res.render ('addwp', {
    title:'AAF 무기 등록'
  });
});
...
router.post('/', async (req, res, next)  => {
  ...
  await  client.query(QueryString, [Wpgrade, Wpname, Wplimit, Wpsocket, Wpether, Wpstats, Wpproperty, Wpfeat, Wpcustom, Wpup], (err, response) => {
