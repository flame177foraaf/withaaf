...
router.get('/:id', (req,res,next) => {
  ...
  client.query(QueryString, (err,response) => {
    ...
    client.query(QueryString, (err, response1) => {
      ...
      var QueryString = "SELECT * FROM aquafeq.monster as t1 left join aquafeq.dungeon_partition as t2 on t1.mon_field = t2.part where mon_field = $1 order by t1.mon_lv,id  asc;"
