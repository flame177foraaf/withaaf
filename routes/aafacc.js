...
router.post('/fixacc', async function(req, res, next) {
  ...
  var QueryString = "UPDATE aquafeq.aquafacc SET (accgrade, acclimit, accsocket, accether, accstats, accproperty, accfeat, acccustom, accup, accname) = ($1, " + Acclimit + "," + "  $2, $3, $4, $5, $6, $7, $8, $9)  WHERE accid = $10 returning *";



  if (Acclimit == '') {
    QueryString = "UPDATE aquafeq.aquafacc SET (accgrade, accsocket, accether, accstats, accproperty, accfeat, acccustom, accup, accname) = ($1, $2, $3, $4, $5, $6, $7, $8, $9)  WHERE accid = $10 returning *";
  }

  await client.query(QueryString, [Accgrade, Accsocket, Accether, Accstats, Accproperty, Accfeat, Acccustom, Accup, Accname, Eqid], async function(err, response) {
